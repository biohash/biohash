...
// encoded data.
size_t decoded_size(const char* encoded_data,  size_t encoded_size);
...
size_t encode(const char* decoded_data,  size_t decoded_size, char* encoded_data);
...
bool decode(const char* encoded_data, size_t encoded_size,
